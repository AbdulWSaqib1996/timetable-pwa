...
const METADATA = ['change-meta', 'kd-chip', 'badge', 'today-hero-label', 'week-strip-dow', 'week-strip-num', 'session-end', 'room-chip', 'free-gap', 'week-badge', 'bell-badge', 'search-count', 'filter-count', 'month-cell', 'week-event', 'chip-small', 'kd-status', 'nav-item', 'attention-dot', 'day-header', 'month-dow', 'month-keydate', 'plan-week-day', 'find-result-head', 'find-result-kind', 'find-result-date', 'week-group', 'session-end', 'shell-profile', 'session-panel-kicker', 'stat-small', 'subject-count-nums', 'session-kind', 'today-row-kind']
